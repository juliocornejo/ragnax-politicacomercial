package com.ragnax.politicacomercial.configuration;
...
public class SwaggerConfig {
	...
	private static final String PACKAGE_CONTROLLER = "com.ragnax.politicacomercial.controller";
	...
	private ApiInfo apiInfo() {
        ...
        return new ApiInfo("Microservices Rest tipocambio", "MicroServicio que implementa " +
                "Politica Comercial a los productos y servicios",
